...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 65.0     // (mm)
  ...
  #define DELTA_HEIGHT 315.6            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0, -1.68, -0.5 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 98.45              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.02, -0.06, 0.04 } // Get these values from G33 auto calibrate
